...
const translations = {
  en: {
    ...
    mission: {
      title: "Our Mission",
      description:
        "To empower women of all ages to take control of their health and well-being. We provide a supportive and inclusive platform that connects individuals with expert-led resources, evidence-based information, and a collaborative community of healthcare professionals.",
      vision: {
        title: "Our Vision",
        description:
  ...
  "pt-PT": {
    ...
    hero: {
      ...
      subtitle:
        "A Eleva Care oferece uma abordagem holística à saúde da mulher, conectando-a com profissionais especializados que apoiam as mulheres em todas as fases da vida.",
    ...
    podcast: {
      ...
      description:
        'Capacite sua jornada de saúde com "Elevando a Saúde das Mulheres" pela Eleva Care. Nossas especialistas decompõem semanalmente as pesquisas mais recentes em saúde da mulher, traduzindo estudos complexos em insights acionáveis. Da saúde reprodutiva à saúde mental, abordamos tudo.',
      cta: "Ouça Agora",
    },
    services: {
    ...
    approach: {
      ...
      description:
        "Na Eleva Care, acreditamos numa abordagem colaborativa do cuidado. Nossa equipe de especialistas trabalha em conjunto para fornecer suporte abrangente e personalizado, garantindo que todos os aspectos da sua saúde sejam atendidos.",
    },
    mission: {
      title: "Nossa Missão",
      description:
        "Capacitar mulheres de todas as idades a assumir o controle de sua saúde e bem-estar. Fornecemos uma plataforma de apoio e inclusiva que conecta indivíduos com recursos liderados por especialistas, informações baseadas em evidências e uma comunidade colaborativa de profissionais de saúde.",
      vision: {
        title: "Nossa Visão",
        description:
          "Preencher a lacuna entre a pesquisa científica e a aplicação prática, oferecendo soluções de cuidados de saúde da mulher acessíveis e personalizadas ao longo de todas as fases da vida.",
      },
      cta: "Junte-se a Nós",
      beliefs: {
  ...
  "es-ES": {
    ...
    hero: {
      ...
      subtitle:
        "Eleva Care ofrece un enfoque holístico para la salud de la mujer, conectándola con proveedores expertos que se especializan en apoyar a las mujeres en cada etapa de la vida.",
      cta1: "Haz un Cuestionario",
      cta2: "Reserva Ahora",
    },
    podcast: {
      title:
        "Elevando la Salud de la Mujer con Patrícia Mota, PT, PhD por Eleva Care",
      description:
        'Potencia tu viaje de salud con "Elevando la Salud de la Mujer" de Eleva Care. Nuestras anfitrionas expertas desglosan semanalmente las investigaciones más recientes en salud de la mujer, traduciendo estudios complejos en conocimientos prácticos. Desde el bienestar reproductivo hasta la salud mental, lo cubrimos todo.',
      cta: "Escucha Ahora",
    },
    services: {
    ...
    approach: {
      ...
      description:
        "En Eleva Care, creemos en un enfoque colaborativo del cuidado. Nuestro equipo de expertos trabaja en conjunto para brindarle un apoyo integral y personalizado, asegurando que se aborden todos los aspectos de su salud.",
    },
    mission: {
      title: "Nuestra Misión",
      description:
        "Empoderar a las mujeres de todas las edades para que tomen el control de su salud y bienestar. Proporcionamos una plataforma de apoyo e inclusiva que conecta a las personas con recursos dirigidos por expertos, información basada en evidencia y una comunidad colaborativa de profesionales de la salud.",
      vision: {
        title: "Nuestra Visión",
        description:
          "Cerrar la brecha entre la investigación científica y la aplicación práctica, ofreciendo soluciones de atención médica para mujeres accesibles y personalizadas a lo largo de cada etapa de la vida.",
      },
    ...
    <div className="flex flex-col min-h-screen bg-white">
      <header className="px-4 lg:px-6 h-16 flex items-center bg-[#0d6c70]">
        ...
        <nav className="ml-auto flex gap-4 sm:gap-6 items-center">
          <Link
            className="text-sm font-medium text-white hover:text-[#16c6cc]"
            href="#services"
          >
            {t.nav.services}
          </Link>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                size="sm"
                className="text-white hover:text-[#16c6cc]"
              >
      ...
      <main className="flex-1">
              ...
              <div className="space-x-4">
                <Dialog>
                  <DialogTrigger asChild>
                    <Button className="bg-white text-[#0d6c70] hover:bg-[#f0f0f0]">
                      {t.hero.cta1}
                    </Button>
                  </DialogTrigger>
          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-2 items-center">
              <div className="space-y-4">
                ...
                <Button
                  className="bg-[#1999e] text-white hover:bg-[#16c6cc]"
                  asChild
                >
                  <Link
        ...
        >
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-2 items-center">
              <div>
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-4 text-[#0d6c70]">
                  {t.mission.title}
                </h2>
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-bold text-[#0d6c70]">
