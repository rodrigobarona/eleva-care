      ...
      >
        <div className="mx-auto max-w-2xl lg:max-w-7xl">
          <div className="grid grid-cols-2">
            <div className="-m-2 rounded-5xl bg-elevaNeutral-100/15 shadow-[inset_0_0_2px_1px_#ffffff4d] ring-1 ring-black/5 max-lg:mx-auto max-lg:max-w-xs">
              <div className="rounded-5xl p-2 shadow-md shadow-black/5">
