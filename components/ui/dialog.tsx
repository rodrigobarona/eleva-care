  ...
  (
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          'max-w-screen fixed left-[50%] top-[50%] z-50 grid max-h-screen w-full translate-x-[-50%] translate-y-[-50%] gap-4 border bg-background p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg md:max-h-[calc(100%-theme(space.8))] md:max-w-[calc(100%-theme(space.8))]',
          className,
        )}
        {...props}
      >
...
const DialogTitle = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Title> & { className?: string } // {{ edit_1 }}
>(
  (
    {
      className,
...
const DialogDescription = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Description> & { className?: string } // {{ edit_1 }}
>(
  (
    {
      className,
